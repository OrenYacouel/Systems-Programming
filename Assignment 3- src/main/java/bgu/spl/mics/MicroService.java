...
public abstract class MicroService implements Runnable {
    ...
    protected MessageBus magicBus;
    protected ConcurrentHashMap <Class<? extends Message>, Callback> messagesCallBacks;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        messagesCallBacks.put(type,callback);
    }
     ...
     *               {@code e}.
     */
    protected final <T> void complete(Event<T> e, T result) { magicBus.complete(e,result);
    }
    ...
    protected final void terminate() {
        System.out.println("reached terminate " + name);
    ...
    public final void run() {
        ...
        while (!isTerminated) {
            ...
            try {
                message = magicBus.awaitMessage(this);
            } catch (InterruptedException e) {
                this.terminate();
            }
//            while (message != null) {
                messagesCallBacks.get(message.getClass()).call(message);

//            }
        }
        System.out.println("Micro-Service "+getName()+" has terminated!");
        magicBus.unregister(this);
    }
